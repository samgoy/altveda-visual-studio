...
const restart_studio_process_1 = require("./restart-studio-process");
...
const studioCommand = async (remotionRoot, args, logLevel) => {
    ...
    const getStudioRuntimeConfig = () => {
        ...
        return {
            ...
            keyboardShortcuts: config_1.ConfigInternals.getKeyboardShortcuts(),
    ...
    await (0, restart_studio_process_1.restartStudioProcess)({
        command: process.execPath,
        args: (0, restart_studio_process_1.getRestartStudioProcessArgs)({
            argv: process.argv,
