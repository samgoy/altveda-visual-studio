...
import type { EffectClipboardParam, GoogleFontSourceEdit } from '@remotion/studio-shared';
...
export declare const updateMultipleSequenceProps: ({ input, changes, ast: providedAst, prettierConfigOverride, }: {
    input: string;
