...
import { type AssetDragPreviewMetadata, type ComponentDragPreviewMetadata, type EffectDragPreviewMetadata, type ElementDragPreviewMetadata, type RenderOutputDragPreviewMetadata, type SfxDragPreviewMetadata } from './drag-preview-metadata';
import { type EffectDragData } from './effect-drag-data';
import { type ElementDragData } from './element-drag-data';
import { type RenderOutputDragData } from './render-output-drag-data';
...
export type MakeElementDragDataInput = Omit<ElementDragData['element'], 'initialProps'> & {
...
export type MakeDragDataInput = MakeAssetDragDataInput | MakeComponentDragDataInput | MakeEffectDragDataInput | MakeElementDragDataInput | MakeRenderOutputDragDataInput | MakeSfxDragDataInput;
...
export type RemotionDragData = AssetDragData | ComponentDragData | EffectDragData | ElementDragData | RenderOutputDragData | SfxDragData;
...
type MakeDragData = {
    ...
    (input: MakeRenderOutputDragDataInput): ConstructedDragData<RenderOutputDragData>;
