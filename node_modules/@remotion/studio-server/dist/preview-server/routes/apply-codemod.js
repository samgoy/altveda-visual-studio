...
exports.applyCodemodHandler = exports.getCodemodLogMessage = exports.formatNewCompositionFile = void 0;
...
const formatNewCompositionFile = (codemod) => (0, studio_codemods_1.makeNewCompositionComponentSource)(codemod);
exports.formatNewCompositionFile = formatNewCompositionFile;
...
const getCodemodLogMessage = (codemod) => {
    ...
    if (codemod.type === 'move-composition-or-folder') {
        const source = codemod.source.type === 'composition'
...
const getCodemodUndoDescription = (codemod) => {
    ...
    if (codemod.type === 'move-composition-or-folder') {
        const label = codemod.source.type === 'composition'
            ? `composition "${codemod.source.compositionId}"`
            : `folder "${getFolderPath(codemod.source.parentName, codemod.source.folderName)}"`;
        return {
            undoMessage: `↩️  Move of ${label}`,
...
const applyCodemodHandler = ({ input: { codemod, dryRun, symbolicatedStack, undoRedoNavigation }, logLevel, remotionRoot, entryPoint, }) => {
        ...
        try {
            ...
            if (!dryRun) {
                ...
                if (codemod.type === 'new-composition') {
                    ...
                    componentFileContents = await (0, exports.formatNewCompositionFile)(codemod);
                    snapshots.push({
