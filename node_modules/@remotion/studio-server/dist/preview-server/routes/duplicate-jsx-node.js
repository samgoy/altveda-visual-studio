    ...
    return (0, source_file_write_queue_1.withSourceFileWriteQueue)(async () => {
        ...
        try {
            ...
            const updates = await Promise.all([...itemsByFileName.entries()].map(async ([fileName, fileItems]) => {
                ...
                const { output, nodeLabels, logLines, nodePathRemappings } = await (0, studio_codemods_1.duplicateJsxNodes)({
                    input: fileContents,
            ...
            for (const update of updates) {
                ...
                renderer_1.RenderInternals.Log.verbose({ indent: false, logLevel }, `[duplicate-jsx-node] Wrote ${update.fileRelativeToRoot}`);
            }
