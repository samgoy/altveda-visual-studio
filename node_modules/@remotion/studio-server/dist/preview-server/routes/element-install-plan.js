...
exports.getElementInstallPlan = exports.makeRelativeElementImportPath = exports.validateElementForInstallation = exports.validateElementInstallPosition = exports.getElementSourceHash = void 0;
...
const getElementInstallPlan = async ({ destination, element, installationName, entryPoint, remotionRoot, }) => {
    var _a;
    ...
    const derivedElementFileName = studio_protocol_1.StudioProtocolInternals.makeElementFileNameFromSlug(installationName !== null && installationName !== void 0 ? installationName : element.slug);
    if (derivedElementFileName === null ||
        (typeof installationName === 'string' &&
            derivedElementFileName !== `${installationName}.element.tsx`)) {
        throw new Error('Use a lowercase installation name with letters, numbers and hyphens, without a file extension.');
    }
