...
const handleInstallPackage = async ({ logLevel, remotionRoot, input: { dependencies }, invalidateBundle, }) => {
    ...
    if (manager.manager === 'yarn') {
        const version = (0, node_child_process_1.execFileSync)('yarn', ['--version'], {
