...
const deliverElementInstall = ({ element, focusStudioTab, liveEventsServer, origin, target, }) => {
    ...
    const installRequest = {
        ...
        element: {
            ...
            initialProps: (_b = element.initialProps) !== null && _b !== void 0 ? _b : null,
            installationMode: (_c = element.installationMode) !== null && _c !== void 0 ? _c : null,
        },
        from: null,
        position: null,
        source: {
...
const handleStudioProtocolInstall = async ({ focusStudioTab, liveEventsServer, request, response, }) => {
    ...
    const requestOrigin = (0, origin_policy_1.getAllowedStudioProtocolOrigin)(request);
