...
const makeUndoEntry = ({ snapshots, description, entryType, suppressHmrOnFileRestore, undoRedoNavigation, }) => {
...
function pushTransactionToUndoStack({ snapshots, logLevel, remotionRoot, description, entryType, suppressHmrOnFileRestore, undoRedoNavigation, }) {
...
function popUndo() {
    ...
    const nodePathMutation = files.length === 0 ? null : (0, sequence_node_path_mutation_1.broadcastSequenceNodePathMutation)(files, null);
    ...
    return {
        success: true,
        nodePathMutation,
        route: (_b = (_a = entry.undoRedoNavigation) === null || _a === void 0 ? void 0 : _a.undoRoute) !== null && _b !== void 0 ? _b : null,
    };
}
function popRedo() {
    var _a;
    ...
    return {
        success: true,
        nodePathMutation,
        route: (_b = (_a = entry.undoRedoNavigation) === null || _a === void 0 ? void 0 : _a.redoRoute) !== null && _b !== void 0 ? _b : null,
    };
}
/*
