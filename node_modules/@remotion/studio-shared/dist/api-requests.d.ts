import type { AudioCodec, BuiltInEditor, ChromeMode, Codec, ColorSpace, DefaultCodingAgent, LogLevel, PixelFormat, StillImageFormat, VideoImageFormat, X264Preset } from '@remotion/renderer';
...
export type ComponentPropValue = string | number | boolean | null | readonly ComponentPropValue[] | Readonly<object>;
export type ComponentProp = {
    name: string;
    value: ComponentPropValue;
};
export type EffectConfigValue = string | number | boolean | null | EffectConfig | readonly EffectConfigValue[];
...
export type SubscribeToSequencePropsBatchRequest = SubscribeToSequencePropsRequest & {
    requests?: SubscribeToSequencePropsRequest[];
};
export type SubscribeToSequencePropsBatchResponse = SubscribeToSequencePropsResponse & {
...
export type ApiRoutes = {
    '/api/invalidate-bundle': ReqAndRes<Record<string, never>, {
    ...
    '/api/open-in-git-client': ReqAndRes<OpenInGitClientRequest, OpenInGitClientResponse>;
    ...
    '/api/subscribe-to-sequence-props': ReqAndRes<SubscribeToSequencePropsBatchRequest, SubscribeToSequencePropsBatchResponse>;
    ...
    '/api/release-notes': ReqAndRes<GetReleaseNotesRequest, GetReleaseNotesResponse>;
    '/api/remotion-skills-info': ReqAndRes<GetRemotionSkillsInfoRequest, GetRemotionSkillsInfoResponse>;
    '/api/install-remotion-skill': ReqAndRes<InstallRemotionSkillRequest, GetRemotionSkillsInfoResponse>;
    '/api/remove-remotion-skill': ReqAndRes<RemoveRemotionSkillRequest, GetRemotionSkillsInfoResponse>;
    ...
    '/api/upgrade-remotion': ReqAndRes<{
        version: string;
    }, {}>;
