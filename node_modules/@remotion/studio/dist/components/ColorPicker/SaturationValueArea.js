...
const valueOverlay = {
    position: 'absolute',
    inset: 0,
    background: colors_1.COLOR_PICKER_SATURATION_BLACK_GRADIENT,
};
const saturationOverlay = {
    position: 'absolute',
    inset: 0,
    background: colors_1.COLOR_PICKER_SATURATION_VALUE_GRADIENT,
};
const SaturationValueArea = ({ hue, saturation, value, onChange, onChangeComplete }) => {
    ...
    const handleStyle = (0, react_1.useMemo)(() => {
        return {
            ...
            marginTop: -6,
            borderRadius: '50%',
            border: colors_1.BORDER_WHITE_2PX,
            boxShadow: colors_1.COLOR_PICKER_HANDLE_SHADOW,
            pointerEvents: 'none',
        };
    }, [saturation, value]);
