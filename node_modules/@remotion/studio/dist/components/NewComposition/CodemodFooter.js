...
const CodemodFooter = ({ codemod, stack, valid, loadingNotification, errorNotification, genericSubmitLabel, submitLabel, onSuccess, fallbackToRootFile = false, applyCodemod, applyCodemodForPreview, }) => {
    var _a;
    ...
    const trigger = (0, react_1.useCallback)(() => {
        ...
        applyCodemod({
            ...
            notification === null || notification === void 0 ? void 0 : notification.dismiss();
