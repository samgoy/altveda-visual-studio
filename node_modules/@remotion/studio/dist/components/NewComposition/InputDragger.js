...
const compactInputDraggerStyle = {
    fontSize: 12,
    lineHeight: '16px',
    padding: '0 6px',
};
const compactInputDraggerContainerStyle = {
    ...exports.inputDraggerContainerStyle,
