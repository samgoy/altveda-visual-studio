...
const Freeze = ({ frame: frameToFreeze, children, active = true, }) => {
    ...
    return (jsx_runtime_1.jsx(TimelineContext_js_1.TimelineContext.Provider, { value: timelineValue, children: jsx_runtime_1.jsx(SequenceContext_js_1.SequenceContext.Provider, { value: newSequenceContext, children: children }) }));
};
