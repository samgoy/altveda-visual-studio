...
crossOrigin, audioStreamIndex, preservePitch: _preservePitch, ...props }) => {
    ...
    return (jsx_runtime_1.jsx(Img_js_1.Img, { src: imageSrc.src, delayRenderRetries: delayRenderRetries, delayRenderTimeoutInMilliseconds: delayRenderTimeoutInMilliseconds, onImageFrame: onImageFrame, ...props, onError: onErr, className: className }));
};
